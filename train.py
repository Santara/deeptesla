...
summary_writer = tf.train.SummaryWriter(params.save_dir, graph=tf.get_default_graph())
...
for i in xrange(params.training_steps):
    ...
    if (i+1) % 10 == 0:
        ...
        print "step {} of {}, train loss {}, val loss {}".format(i+1, params.training_steps, this_loss)
